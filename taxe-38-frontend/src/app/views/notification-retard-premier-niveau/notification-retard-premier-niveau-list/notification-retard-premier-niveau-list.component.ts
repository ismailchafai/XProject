...
@Component({
  selector: 'app-notification-retard-premier-niveau-list',
  standalone: true,
  imports: [
  ...
  templateUrl: './notification-retard-premier-niveau-list.Component.html',
  styleUrl: './notification-retard-premier-niveau-list.Component.scss'
})
export class NotificationRetardPremierNiveauListComponent {
