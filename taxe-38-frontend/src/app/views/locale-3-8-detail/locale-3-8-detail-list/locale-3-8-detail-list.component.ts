...
@Component({
  selector: 'app-locale-3-8-detail-list',
  standalone: true,
  imports: [
  ...
  templateUrl: './locale-3-8-detail-list.Component.html',
  styleUrl: './locale-3-8-detail-list.Component.scss'
})
export class Locale38DetailListComponent {
