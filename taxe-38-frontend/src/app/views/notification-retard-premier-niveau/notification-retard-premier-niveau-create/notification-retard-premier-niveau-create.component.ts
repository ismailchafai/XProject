...
@Component({
  selector: 'app-notification-retard-premier-niveau-create',
  standalone: true,
  imports: [
  ...
  templateUrl: './notification-retard-premier-niveau-create.component.html',
  styleUrl: './notification-retard-premier-niveau-create.component.scss'
})
export class NotificationRetardPremierNiveauCreateComponent {
  ...
  reset(force = true) {
    if (force || this.item == null) this.item = new NotificationRetardPremierNiveau()
