...
@Component({
  selector: 'app-notification-retard-deuxieme-niveau-list',
  standalone: true,
  imports: [
  ...
  templateUrl: './notification-retard-deuxieme-niveau-list.Component.html',
  styleUrl: './notification-retard-deuxieme-niveau-list.Component.scss'
})
export class NotificationRetardDeuxiemeNiveauListComponent {
