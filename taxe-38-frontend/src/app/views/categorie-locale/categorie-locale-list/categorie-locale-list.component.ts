...
@Component({
  selector: 'app-categorie-locale-list',
  standalone: true,
  imports: [
  ...
  templateUrl: './categorie-locale-list.Component.html',
  styleUrl: './categorie-locale-list.Component.scss'
})
export class CategorieLocaleListComponent {
