...
@Component({
  selector: 'app-notification-retard-deuxieme-niveau-detail-type-3-8-list',
  standalone: true,
  imports: [
  ...
  templateUrl: './notification-retard-deuxieme-niveau-detail-type-3-8-list.Component.html',
  styleUrl: './notification-retard-deuxieme-niveau-detail-type-3-8-list.Component.scss'
})
export class NotificationRetardDeuxiemeNiveauDetailType38ListComponent {
