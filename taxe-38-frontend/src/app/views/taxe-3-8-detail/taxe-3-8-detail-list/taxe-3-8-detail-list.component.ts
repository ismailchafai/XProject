...
@Component({
  selector: 'app-taxe-3-8-detail-list',
  standalone: true,
  imports: [
  ...
  templateUrl: './taxe-3-8-detail-list.Component.html',
  styleUrl: './taxe-3-8-detail-list.Component.scss'
})
export class Taxe38DetailListComponent {
