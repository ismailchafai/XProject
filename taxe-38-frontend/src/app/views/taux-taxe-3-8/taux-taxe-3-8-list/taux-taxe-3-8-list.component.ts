...
@Component({
  selector: 'app-taux-taxe-3-8-list',
  standalone: true,
  imports: [
  ...
  templateUrl: './taux-taxe-3-8-list.Component.html',
  styleUrl: './taux-taxe-3-8-list.Component.scss'
})
export class TauxTaxe38ListComponent {
