...
@Component({
  selector: 'app-notification-retard-deuxieme-niveau-update',
  standalone: true,
  imports: [
  ...
  templateUrl: './notification-retard-deuxieme-niveau-update.component.html',
  styleUrl: './notification-retard-deuxieme-niveau-update.component.scss'
})
export class NotificationRetardDeuxiemeNiveauUpdateComponent {
  ...
  ngAfterContentInit() {
    if (!this.isPartOfUpdateForm && this.item.id == null) this.router.navigate(["/notification-retard-deuxieme-niveau"]).then()
  }
